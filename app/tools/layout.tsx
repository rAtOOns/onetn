  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)]">
      ...
      <button
        ...
        className="lg:hidden fixed bottom-4 right-4 z-50 bg-gradient-to-br from-tn-primary to-tn-secondary text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-shadow"
      >
      ...
      <aside
        className={`
          ...
          w-72 bg-gradient-to-b from-emerald-50 to-green-50 border-r border-emerald-100 overflow-y-auto
      ...
      >
        <div className="p-4 space-y-4">
          ...
          <Link href="/tools" className="block">
            <h2 className="text-lg font-bold text-tn-primary">Tools & Calculators</h2>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2.5 text-sm border border-emerald-200 rounded-lg bg-white focus:ring-2 focus:ring-tn-primary focus:border-tn-primary focus:outline-none transition-all"
            />
          </div>

          {/* Tool Stats */}
          <div className="grid grid-cols-2 gap-2">
            <div className="px-3 py-2 bg-gradient-to-br from-emerald-100 to-emerald-50 rounded-lg text-center">
              <div className="text-lg font-bold text-tn-primary">{allTools.length}</div>
              <div className="text-xs text-gray-600">Total Tools</div>
            </div>
            <div className="px-3 py-2 bg-gradient-to-br from-green-100 to-green-50 rounded-lg text-center">
            ...
            {filteredCategories.map((category) => (
              <div key={category.name}>
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-2.5 text-sm font-semibold text-tn-primary hover:bg-emerald-100 rounded-lg transition-colors duration-200"
                >
                  <span>{category.name}</span>
                  {expandedCategories.has(category.name) ? (
                    <ChevronDown size={16} className="text-tn-secondary" />
                  ) : (
                      ...
                      return (
                        <Link
                          ...
                          className={`
                            ...
                            ${
                              isActive
                                ? "bg-gradient-to-r from-tn-primary to-tn-secondary text-white shadow-md"
