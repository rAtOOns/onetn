...
const tools: Tool[] = [
  ...
  {
    id: "increment-arrears",
    name: "Increment Arrears Calculator",
    nameTamil: "ஊதிய உயர்வு நிலுவை",
    description: "Calculate arrears when increment is delayed",
    icon: TrendingUp,
    href: "/tools/increment-arrears",
    color: "bg-purple-600",
    category: "Salary & Pay",
    isNew: true,
  },
  {
    id: "stepping-up-calculator",
    name: "Stepping Up Calculator",
    nameTamil: "படிநிலை சரிசெய்தல்",
    description: "Calculate pay stepping up when junior draws more",
    icon: ArrowUpCircle,
    href: "/tools/stepping-up-calculator",
    color: "bg-rose-600",
    category: "Salary & Pay",
    isNew: true,
  },
  ...
  {
    id: "hra-city-category",
    name: "HRA by City Category",
    nameTamil: "நகர வகை படி HRA",
    description: "HRA rates based on city classification X, Y, Z",
    icon: Building2,
    href: "/tools/hra-city-category",
    color: "bg-indigo-500",
    category: "Tax & Deductions",
    isNew: true,
  },
  ...
  {
    id: "tngis-calculator",
    name: "TNGIS Calculator",
    nameTamil: "TNGIS கால்குலேட்டர்",
    description: "Tamil Nadu Govt Insurance Scheme premium & benefits",
    icon: Shield,
    href: "/tools/tngis-calculator",
    color: "bg-blue-600",
    category: "Provident Fund",
    isNew: true,
  },
  ...
  {
    id: "commutation-restoration",
    name: "Commutation Restoration",
    nameTamil: "ஓய்வூதிய மீட்டெடுப்பு",
    description: "Track pension restoration after 15 years commutation",
    icon: RefreshCw,
    href: "/tools/commutation-restoration",
    color: "bg-teal-600",
    category: "Retirement Planning",
    isNew: true,
  },
      ...
      },
  {
    ...
    nameTamil: "குழந்தைகள் கல்வி படி",
    description: "Calculate CEA for school and college children",
    icon: GraduationCap,
    href: "/tools/children-education-allowance",
    color: "bg-green-600",
    category: "Service Matters",
    isNew: true,
  },
  {
    id: "festival-advance",
    name: "Festival Advance Calculator",
    nameTamil: "திருவிழா முன்பணம்",
    description: "Calculate festival advance and recovery schedule",
    icon: Gift,
    href: "/tools/festival-advance",
    color: "bg-orange-500",
    category: "Service Matters",
    isNew: true,
  },
  {
    id: "hostel-subsidy",
    name: "Hostel Subsidy Guide",
    nameTamil: "விடுதி மானியம்",
    description: "Calculate hostel subsidy for children education",
    icon: Home,
    href: "/tools/hostel-subsidy",
    color: "bg-cyan-600",
    category: "Service Matters",
    isNew: true,
  },
  {
    ...
    nameTamil: "பணிச்சுமை கால்குலேட்டர்",
    description: "Calculate teaching workload as per norms",
    icon: Clock,
    href: "/tools/workload-calculator",
    color: "bg-blue-600",
    category: "Service Matters",
    isNew: true,
  },
  {
    id: "staff-pattern",
    name: "Staff Pattern Calculator",
    nameTamil: "பணியாளர் கட்டமைப்பு",
    description: "Calculate sanctioned staff based on student strength",
    icon: Users,
    href: "/tools/staff-pattern",
    color: "bg-violet-600",
    category: "Service Matters",
    isNew: true,
  },
